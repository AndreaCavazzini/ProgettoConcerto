...
$(document).ready(function () {
    ...
    $(".countdown")
        .countdown("2019/02/06", function (event) {
            $(this).html(
                event.strftime('<div>%w <span>Settimane</span></div>  <div>%D <span>Giorni</span></div>  <div>%H<span>Ore</span></div> <div>%M<span>Minuti</span></div> <div>%S<span>Secondi</span></div>')
            );
        });
